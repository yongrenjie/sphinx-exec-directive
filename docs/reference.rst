...
Technically, you can ``import sphinx_exec_directive`` in a script and use the functions within just like any other Python package (if for some reason that is useful).
